            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="date" id="fecha-selector" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
...
<script src="<?php echo e(asset('js/3d-visualizer.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\EMANUELCLEMENTEMARTI\Downloads\sistema hotel\resources\views/hotel/3d-rooms.blade.php ENDPATH**/ ?>