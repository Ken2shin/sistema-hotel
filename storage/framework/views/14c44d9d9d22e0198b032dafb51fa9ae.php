        ...
        <div class="bg-white/70 backdrop-blur-xl rounded-3xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-extrabold text-slate-800 mt-2"><?php echo e($stats['total_reservations'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white/70 backdrop-blur-xl rounded-3xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-extrabold text-slate-800 mt-2"><?php echo e($stats['total_clients'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white/70 backdrop-blur-xl rounded-3xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-extrabold text-slate-800 mt-2">$<?php echo e(number_format($stats['total_revenue'] ?? 0, 2)); ?></p>
                </div>
        ...
        <div class="bg-white/70 backdrop-blur-xl rounded-3xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-extrabold text-slate-800 mt-2"><?php echo e($occupancy_rate ?? 0); ?>%</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white/80 backdrop-blur-xl rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
            <div class="px-7 py-5 border-b border-slate-100/60 flex items-center justify-between">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('admin.reservations')): ?>
                    <a href="<?php echo e(route('admin.reservations')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-bold bg-blue-50 px-4 py-1.5 rounded-full transition-colors">Ver todas</a>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100/60">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent_reservations ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50/50 transition duration-200">
                                <td class="px-7 py-4 text-slate-800 font-semibold"><?php echo e($reservation->client->nombre ?? 'N/A'); ?></td>
                                <td class="px-7 py-4 text-slate-600"><?php echo e($reservation->room->numero ?? 'N/A'); ?></td>
                                <td class="px-7 py-4 text-slate-600"><?php echo e($reservation->fecha_inicio ? \Carbon\Carbon::parse($reservation->fecha_inicio)->format('d M, Y') : 'N/A'); ?></td>
                                <td class="px-7 py-4">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold
                                        <?php if($reservation->estado === 'confirmada'): ?> bg-emerald-100 text-emerald-700
                                        <?php elseif($reservation->estado === 'pendiente'): ?> bg-amber-100 text-amber-700
                                        <?php else: ?> bg-red-100 text-red-700
                                        <?php endif; ?>">
                                        <?php echo e(match($reservation->estado) {
                                            'confirmada' => 'Confirmada',
                                            'pendiente' => 'Pendiente',
                                            'cancelada' => 'Cancelada',
                                            default => ucfirst($reservation->estado ?? 'N/A')
                                        }); ?>
        ...
        <!-- Panel Lateral: Detalles Adicionales -->
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-7 flex flex-col justify-center">
            ...
            <div class="bg-slate-50/80 rounded-2xl p-5 mb-6 border border-slate-100">
                ...
                <div class="flex items-center justify-between mb-2">
                    <div class="w-full bg-slate-200/60 rounded-full h-3 mr-4 overflow-hidden">
                        <div class="bg-purple-500 h-3 rounded-full transition-all duration-1000 ease-out" style="width: <?php echo e($occupancy_rate ?? 0); ?>%"></div>
                    </div>
                    <span class="text-base font-extrabold text-slate-800"><?php echo e($occupancy_rate ?? 0); ?>%</span>
                </div>
                <p class="text-xs font-medium text-slate-500 text-right"><?php echo e($stats['occupied_rooms'] ?? 0); ?> de <?php echo e($stats['total_rooms'] ?? 0); ?> ocupadas</p>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-blue-50/50 rounded-2xl p-4 border border-blue-100/50 text-center">
                    ...
                    <p class="text-3xl font-extrabold text-blue-700"><?php echo e($stats['pending_reservations'] ?? 0); ?></p>
                </div>
                <div class="bg-emerald-50/50 rounded-2xl p-4 border border-emerald-100/50 text-center">
                    ...
                    <p class="text-3xl font-extrabold text-emerald-700"><?php echo e(($stats['total_rooms'] ?? 0) - ($stats['occupied_rooms'] ?? 0)); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\EMANUELCLEMENTEMARTI\Downloads\sistema hotel\resources\views/dashboard.blade.php ENDPATH**/ ?>