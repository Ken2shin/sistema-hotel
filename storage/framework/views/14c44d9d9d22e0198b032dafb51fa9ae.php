        ...
        <div class="bg-white rounded-lg border border-slate-200 p-6 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900 mt-1"><?php echo e($stats['total_reservations'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg border border-slate-200 p-6 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900 mt-1"><?php echo e($stats['total_clients'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg border border-slate-200 p-6 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900 mt-1">$<?php echo e(number_format($stats['total_revenue'] ?? 0, 2)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg border border-slate-200 p-6 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900 mt-1"><?php echo e($occupancy_rate ?? 0); ?>%</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 bg-white rounded-lg border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('admin.reservations')): ?>
                    <a href="<?php echo e(route('admin.reservations')); ?>" class="text-blue-600 hover:text-blue-700 text-sm font-medium">Ver todas</a>
                    ...
                    <tbody class="divide-y divide-slate-200">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent_reservations ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50 transition">
                                <td class="px-6 py-3 text-slate-900"><?php echo e($reservation->client->nombre ?? 'N/A'); ?></td>
                                <td class="px-6 py-3 text-slate-900"><?php echo e($reservation->room->numero ?? 'N/A'); ?></td>
                                <td class="px-6 py-3 text-slate-600"><?php echo e($reservation->fecha_inicio ? \Carbon\Carbon::parse($reservation->fecha_inicio)->format('d M, Y') : 'N/A'); ?></td>
                                <td class="px-6 py-3">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                                        <?php if($reservation->estado === 'confirmada'): ?> bg-green-100 text-green-700
        ...
        <div class="bg-white rounded-lg border border-slate-200 p-6">
            ...
            <div class="flex flex-col items-center justify-center py-8">
                <div class="text-4xl font-bold text-slate-900">$<?php echo e(number_format($revenue_today ?? 0, 2)); ?></div>
                    ...
                    <div class="bg-slate-50 rounded-lg p-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="w-full bg-slate-200 rounded-full h-2 mr-3">
                                <div class="bg-purple-600 h-2 rounded-full transition-all" style="width: <?php echo e($occupancy_rate ?? 0); ?>%"></div>
                            </div>
                            <span class="text-sm font-bold text-slate-900"><?php echo e($occupancy_rate ?? 0); ?>%</span>
                        </div>
                        <p class="text-xs text-slate-600 mt-2"><?php echo e($stats['occupied_rooms'] ?? 0); ?> de <?php echo e($stats['total_rooms'] ?? 0); ?> habitaciones</p>
                    </div>
                    <div class="grid grid-cols-2 gap-3 text-xs">
                        <div class="bg-blue-50 rounded-lg p-3">
                            <p class="text-blue-600 font-medium">Reservas Pendientes</p>
                            <p class="text-2xl font-bold text-blue-700"><?php echo e($stats['pending_reservations'] ?? 0); ?></p>
                        </div>
                        <div class="bg-green-50 rounded-lg p-3">
                            <p class="text-green-600 font-medium">Disponibles</p>
                            <p class="text-2xl font-bold text-green-700"><?php echo e(($stats['total_rooms'] ?? 0) - ($stats['occupied_rooms'] ?? 0)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
